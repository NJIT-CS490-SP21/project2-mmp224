...
from app import database_test
import models

KEY_INPUT = "input"
KEY_EXPECTED = "expected"

INITIAL_USERNAME = 'userA'

class AddUserTestCase(unittest.TestCase):
    def setUp(self):
        self.success_test_params = [
            {
                KEY_INPUT: {'setPlayer' : "userA"},
                KEY_EXPECTED: [INITIAL_USERNAME, 'userA'],
            },
        ]
        self.fail_test_params = [
            {
                KEY_INPUT: {'setPlayer' : "userA"},
                KEY_EXPECTED: [INITIAL_USERNAME, 'userB'],
            },
        ]
            ...
            with patch('app.db.session.add', self.mocked_db_session_add):
                with patch('app.db.session.commit', self.mocked_db_session_commit):
                    with patch('models.Person.query') as mocked_query:
                        ...
                        actual_result = database_test(test[KEY_INPUT])
                        print(actual_result)
